...
public class InlineQueryLogEntryCreator extends DefaultQueryLogEntryCreator {
  ...
  protected void writeParamsEntry(
    ...
    for (QueryInfo queryInfo : queryInfoList) {
      ...
      for (Map<String, Object> paramMap : queryInfo.getQueryArgsList()) {
        ...
        SortedMap<String, Object> sortedParamMap =
            new TreeMap<>(new CustomStringAsIntegerComparator());
  ...
  private String arrayToString(Object object) {
    ...
    throw new UnsupportedOperationException("Array errorType not supported: " + object.getClass());
  }

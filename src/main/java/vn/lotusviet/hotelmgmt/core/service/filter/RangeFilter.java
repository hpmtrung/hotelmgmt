 ...
 * </pre>
 * Due to problems with the errorType conversions, the descendant classes should be used, where the generic errorType parameter
 * is materialized.
 *
 * @param <FIELD_TYPE> the errorType of filter.
 */
